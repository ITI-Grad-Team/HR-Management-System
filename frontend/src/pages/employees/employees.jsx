    ...
    const fetchEmployees = async () => {
      try {
        ...
        localStorage.setItem(
          "employees",
          JSON.stringify(employeeRes.data.results)
        );
        ...
        if (role === "hr") {
          ...
          localStorage.setItem(
            "candidates",
            JSON.stringify(candidateRes.data.results)
          );
        }
      } catch (err) {
        console.error(err);
        ...
        {role === "admin" && (
          <SectionBlock title="HRs">
            {hrs.length > 0 ? (
                        ...
                        <div key={hr.id}>
                          ...
                          >
                            <BioCard
                              ...
                              avatar={
                                hr.basic_info.profile_image || "/default.jpg"
                              }
              ...
              <div className="text-center text-muted mt-4">No HRs found.</div>
            )}
          </SectionBlock>
        )}
        {/* Employees Section */}
                    ...
                    <div key={employee.id}>
                      ...
                      >
                        <BioCard
                          ...
                          education={employee.highest_education_field} // Add this line
                          isCoordinator={employee.is_coordinator}
                          interviewDate={employee.interview_datetime}
